...
```bash
$ git clone git@github.com:finalgene/docker-hub-phing.git
```

- Or via HTTPS:

```bash
$ git clone https://github.com/finalgene/docker-hub-phing.git
```
...
2. Fork the repository (http://github.com/finalgene/docker-hub-phing)
...
```bash
$ git remote add {username} git@github.com:{username}/docker-hub-phing.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/docker-hub-phing.git
